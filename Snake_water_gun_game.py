...
while(choice<=9):
    ...
    if user_choose == "snake" and comp_choose == "snake":
        ...
        comp_time += 1
        user_time += 1
    if user_choose == "water" and comp_choose == "water":
        print("tie")
        comp_time += 1
        user_time += 1
    if user_choose == "gun" and comp_choose == "gun":
        print("tie")
        comp_time += 1
        user_time += 1
    if user_choose == "snake" and comp_choose == "gun":
        print("computer win")
        comp_time += 1
    if user_choose == "gun" and comp_choose == "snake":
        print("user win")
        user_time += 1
    if user_choose == "gun" and comp_choose == "water":
        print("computer win")
        comp_time += 1
    if user_choose == "water" and comp_choose == "gun":
        print("user win")
        user_time += 1
    if user_choose == "snake" and comp_choose == "water":
        print("computer win")
        comp_time += 1
    if user_choose == "water" and comp_choose == "snake":
        print("user win")
        user_time += 1
    else:
        print("invalid")
